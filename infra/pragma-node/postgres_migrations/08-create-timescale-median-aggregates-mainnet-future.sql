CREATE MATERIALIZED VIEW mainnet_future_price_10_s_agg
...
SELECT add_continuous_aggregate_policy('mainnet_future_price_10_s_agg',
  start_offset => INTERVAL '1 day',
  end_offset => INTERVAL '10 seconds',
  schedule_interval => INTERVAL '10 seconds');

CREATE MATERIALIZED VIEW mainnet_future_price_1_min_agg
WITH (timescaledb.continuous, timescaledb.materialized_only = false)
AS SELECT 
    pair_id,
...
SELECT add_continuous_aggregate_policy('mainnet_future_price_1_min_agg',
  start_offset => INTERVAL '1 day',
  end_offset => INTERVAL '1 min',
  schedule_interval => INTERVAL '1 min');


CREATE MATERIALIZED VIEW mainnet_future_price_15_min_agg
WITH (timescaledb.continuous, timescaledb.materialized_only = false)
AS SELECT 
    pair_id,
...
SELECT add_continuous_aggregate_policy('mainnet_future_price_15_min_agg',
  start_offset => NULL,
  end_offset => INTERVAL '15 min',
  schedule_interval => INTERVAL '15 min');


CREATE MATERIALIZED VIEW mainnet_future_price_1_hour_agg
WITH (timescaledb.continuous, timescaledb.materialized_only = false)
AS SELECT 
    pair_id,
...
SELECT add_continuous_aggregate_policy('mainnet_future_price_1_hour_agg',
  start_offset => NULL,
  end_offset => INTERVAL '1 hour',
  schedule_interval => INTERVAL '1 hour');


CREATE MATERIALIZED VIEW mainnet_future_price_2_hour_agg
WITH (timescaledb.continuous, timescaledb.materialized_only = false)
AS SELECT 
    pair_id,
...
SELECT add_continuous_aggregate_policy('mainnet_future_price_2_hour_agg',
  start_offset => NULL,

...
SELECT add_continuous_aggregate_policy('future_price_1_min_agg',
  start_offset => NULL,
...
SELECT add_continuous_aggregate_policy('future_price_15_min_agg',
  start_offset => NULL,
...
SELECT add_continuous_aggregate_policy('future_price_1_hour_agg',
  start_offset => NULL,
...
SELECT add_continuous_aggregate_policy('future_price_2_hour_agg',
  start_offset => NULL,
